...
const cssmerge = require('../05-merge-styles/index.js');
const assetcopy = require('../04-copy-directory/index.js');
...
cssmerge.mergeStyles(distDirPath, distStylePath, stylesDirPath);
assetcopy(distDirPath, assetsDirPath, distAssetsDirPath);
